...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Home Resort</title>
...
==============================-->
    <div class="hero-6" id="hero">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_6_1.jpg">
                        </div>
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_6_2.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style6">
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.2s">
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_6_3.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style6">
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.2s">
        ...
        <div class="th-swiper-custom">
            <button data-slider-prev="#heroSlide6" class="slider-arrow slider-prev"><img src="assets/img/icon/right-arrow.svg" alt=""></button>
            <button data-slider-next="#heroSlide6" class="slider-arrow slider-next"><img src="assets/img/icon/left-arrow.svg" alt=""></button>
        </div>
    </div>
    <!--======== / Hero Section ========--><!--==============================
Booking Area  
    ...
    <div class="destination-area6 position-relative space" id="destination-sec">
        <div class="container">
            ...
            <div class="row">
                <div class="destination-list-area">
                    <div class="destination-list-wrap style2 active">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_5_1.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                                    <a href="destination-details.php">Indonesia</a>
                                </h4>
                                <span class="destination-subtitle">28 Listing</span>
                            </div>
                            <a href="contact.php" class="th-btn style2">Book Now</a>
                        </div>
                    </div>
                    <div class="destination-list-wrap style2">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_5_2.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                                    <a href="destination-details.php">Thailand</a>
                                </h4>
                    ...
                    <div class="destination-list-wrap style2">
                        <div class="destination-list" data-bg-src="assets/img/destination/destination_5_3.jpg">
                            <div class="destination-content">
                                <h4 class="box-title">
                                    <a href="destination-details.php">Maldives</a>
                                </h4>
            ...
            <div class="destination-btn text-center mt-60">
                <a href="destination.php" class="th-btn style3 th-icon">View All</a>
            </div>
        </div>
    </div><!--==============================
feature Area  
                ...
                <div class="col-xl-4">
                    <div class="about-area6">
                        <div class="title-area mb-30">
                            <span class="sub-title style1 ">About Our Resort</span>
                            <h2 class="sec-title mb-20">Our Luxurious Resort</h2>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row gx-60 gy-30 mb-60 align-items-center">
                <div class="col-lg-6">
                    <div class="resort-image global-img">
                        <img src="assets/img/normal/resort_1_1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="resort-content">
                        <h3 class="box-title"><a href="resort-details.php">Ocean View Resort</a></h3>
            ...
            <div class="row gx-60 gy-30 mb-60 align-items-center">
                <div class="col-lg-6 order-lg-4">
                    <div class="resort-image global-img">
                        <img src="assets/img/normal/resort_1_2.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="resort-content">
                        <h3 class="box-title"><a href="resort-details.php">Premiur Forest Resort</a></h3>
                        <div class="resort-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                    <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                    Rating)</span></div>
            ...
            <div class="row gx-60 gy-30 mb-60 align-items-center">
                <div class="col-lg-6">
                    <div class="resort-image global-img">
                        <img src="assets/img/normal/resort_1_3.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="resort-content">
                        <h3 class="box-title"><a href="resort-details.php">Delux Hilltop Resort</a></h3>
                        <div class="resort-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                    <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                    Rating)</span></div>
            ...
            <div class="resort-btn text-center mt-60">
                <a href="resort.php" class="th-btn style3 th-icon">See More Resort</a>
            </div>
        </div>
    </div><!--==============================
Counter Area  
...
Contact Area  
==============================-->
    <div class="bg-top-center position-relative  overflow-hidden" data-bg-src="assets/img/bg/contact_bg_5.jpg">
        <div class="container">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">New Jersey resorts offer a range of options from luxurious</a></h3>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                ...
                                <div class="blog-box_content">
                                    <div class="blog-meta">
                                        <a class="author" href="blog.php">Sep 06 2024</a>
                                        <a href="blog.php">7 min read</a>
                                    </div>
                                    <h3 class="box-title"><a href="blog-details.php">Pamper yourself with world-class spa treatments, wellness </a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">Savor gourmet cuisine and local specialties prepared by top</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box th-ani">
                                ...
                                <div class="blog-box_content">
                                    <div class="blog-meta">
                                        <a class="author" href="blog.php">Sep 12 2024</a>
                                        <a href="blog.php">11 min read</a>
                                    </div>
                                    <h3 class="box-title"><a href="blog-details.php">Savor gourmet cuisine and local specialties prepared by top</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
            ...
            <div class="gallery-area3">
                <div class="slider-area">
                    <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"4"},"1400":{"slidesPerView":"6"}}}'>
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_1.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_2.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_3.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_4.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_5.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_10_6.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
