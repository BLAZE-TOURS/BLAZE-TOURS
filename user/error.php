...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Error Page</title>
            ...
            <div class="row flex-row-reverse align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="error-content">
                        ...
                        <a href="home-travel.php" class="th-btn style3"><img src="assets/img/icon/right-arrow2.svg" alt="">Go Back Home</a>
                    </div>
                </div>
            </div>
        </div>
