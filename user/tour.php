                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row gy-24 gx-24">
                                    ...
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            ...
                                            <div class="tour-action">
                                                ...
                                                <a href="tour-details.php" class="th-btn style4">Detail View</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Belgium Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Maldives Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Paris Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Switzerland Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Bali Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                        ...
                        <div class="th-pagination text-center mt-60">
                            <ul>
                                <li><a class="active" href="tour.php">1</a></li>
                                <li><a href="tour.php">2</a></li>
                                <li><a href="tour.php">3</a></li>
                                <li><a href="tour.php">4</a></li>
                                <li><a class="next-page" href="tour.php">Next <img src="assets/img/icon/arrow-right4.svg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
