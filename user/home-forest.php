...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - forest Home</title>
                        ...
                        <div class="container">
                            <div class="hero-style8">
                                ...
                                <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.6s">
                                    <a href="tour.php" class="th-btn style1 th-icon">Explore Tours</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Adventure Tours</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Wildlife Safaris</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Relaxation Retreats</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Customized Experiences</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                ...
                <div class="swiper th-slider has-shadow" id="destinationSlider6" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-item2 th-ani">
                                <div class="box-img global-img">
                                    <img src="assets/img/destination/destination_7_1.jpg" alt="image">
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="destination-details.php">Costa Rica Forest</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item2 th-ani">
                                <div class="box-img global-img">
                                    <img src="assets/img/destination/destination_7_2.jpg" alt="image">
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="destination-details.php">Black Forest, Germany</a></h3>
                                    <p class="box-text">25 Listing</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item2 th-ani">
                                <div class="box-img global-img">
                                    <img src="assets/img/destination/destination_7_3.jpg" alt="image">
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="destination-details.php">Amazon Jungle</a></h3>
                                    <p class="box-text">25 Listing</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    ...
                    <div class="swiper th-slider testi-grid2-thumb style2" data-slider-options='{"effect":"slide","slidesPerView":"6","spaceBetween":7,"loop":false}'>
                        <div class="icon-box">
                            <button data-slider-prev="#testiSlide7" class="slider-arrow default"><img src="assets/img/icon/right-arrow2.svg" alt=""></button>
                            <button data-slider-next="#testiSlide7" class="slider-arrow default"><img src="assets/img/icon/left-arrow2.svg" alt=""></button>
                        </div>
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="box-img">
...
==============================-->
    ...
    <div class="bg-smoke overflow-hidden space">
        ...
        <div class="shape-mockup d-none d-xxl-block" data-top="5%" data-right="0%"><img src="assets/img/shape/shape_19.png" alt="">
        </div>
        <div class="shape-mockup d-none d-xxl-block" data-bottom="0%" data-left="0%"><img src="assets/img/shape/shape_20.png" alt="">
        </div>
    </div><!--==============================
Counter Area  
==============================-->
...
Contact Area  
==============================-->
    <div class="bg-top-center position-relative  overflow-hidden" data-bg-src="assets/img/bg/contact_bg_7.jpg">
        <div class="container">
...
==============================-->
            ...
            <div class="row gx-24 gy-30">
                <div class="col-xl-5">
                    <div class="blog-grid th-ani">
                        ...
                        <div class="blog-grid_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">July 05, 2024</a>
                                <a href="blog.php">6 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">10 Remarkable Wildlife Travel Experiences That Will Take You on Unforgettable Adventures.</a></h3>
                ...
                <div class="col-xl-7">
                    <div class="blog-grid style2 th-ani">
                        ...
                        <div class="blog-grid_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">July 07, 2024</a>
                                <a href="blog.php">7 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">Exploring the Wonders of the Wild: Forest Tour Highlights</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
                    <div class="blog-grid th-ani style2 mt-24">
                        ...
                        <div class="blog-grid_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">July 10, 2024</a>
                                <a href="blog.php">8 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">The Forest Gazette: Recent Highlights and Future Tour Plans</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
                </div>
	...
	Footer Area
==============================-->
    <footer class="footer-wrapper bg-title footer-layout2 footer-layout5 space-top" data-bg-src="assets/img/bg/footer_bg-2.png">
        <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_12_2.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_12_3.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_12_4.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_12_5.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb2 style2">
                                    <img src="assets/img/gallery/gallery_12_6.jpg" alt="Gallery Image">
                                    <a target="_blank" href="https://www.instagram.com/" class="gallery-btn"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
        ...
        <div class="shape-mockup spin d-none d-xxl-block" data-top="10%" data-left="4%">
            <img src="assets/img/shape/shape_2_11.png" alt="shape">
        </div>
