    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <p class="copyright-text">Copyright 2025 <a href="home-travel.php">BLAZE TOURS (PVT) LTD</a></p>
                </div>
                <div class="col-md-6 text-end">
                    <p class="copyright-text">Develop and design by <a href="https://tecxone.software/" target="_blank" rel="noopener noreferrer" class="text-danger fw-bold">Tecxone Software Solution</a></p>
                </div>
            </div>
