...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Shop Details</title>
            ...
            <div class="row gx-60">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <p class="text">Bluetooth headphones are a popular choice for many people due to their convenience and wireless capabilities. They allow users to listen to music, podcasts, or make calls without being tethered to their device</p>
                        ...
                        <div class="product_meta">
                            ...
                            <span class="posted_in">Category: <a href="shop.php"> sports, gaming, music listening</a></span>
                            <span>Tags: <a href="shop.php">Wireless</a><a href="shop.php">Sports</a></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-60">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <div class="product-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span></div>
                            <a href="shop-details.php" class="woocommerce-review-link">(<span class="count">4</span>
                                customer reviews)</a>
                        </div>
                        ...
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">BH-1001-BT</span></span>
                            <span class="posted_in">Category: <a href="shop.php"> sports, gaming, music
                                    listening</a></span>
                            <span>Tags: <a href="shop.php">Wireless</a><a href="shop.php">Sports</a></span>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Flooring-Vinyl</a></h3>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Cement Metal Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Metal Roof Steel</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Roof Tiles Braas</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Ceramic Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Wall Formwork</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    <span class="price">$235.00</span>
                                    <h3 class="product-title"><a href="shop-details.php">Flashing Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    <span class="price">$250.00<del>$550.00</del></span>
                                    <h3 class="product-title"><a href="shop-details.php">Roof Topwet</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
