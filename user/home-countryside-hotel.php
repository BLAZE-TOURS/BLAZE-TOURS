...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Home Yacht</title>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                <a href="contact.php" class="th-btn style3 style1 th-icon">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
...
Hero Area
==============================-->
    <div class="th-hero-wrapper hero-7" id="hero" data-bg-src="assets/img/bg/hero_bg_7_1.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 col-xl-8">
                    <div class="hero-style7">
                        ...
                        <div class="btn-group">
                            <a href="tour.php" class="th-btn th-icon">Explore Tours</a>
                            <a href="service.php" class="th-btn style2 th-icon">Our Services</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper th-slider has-shadow categorySlider4" id="categorySlider4" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"5"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="category-card style3">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_3_1.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">New Zealand</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style3">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_3_2.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">The Amazon</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style3">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_3_3.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Angel Falls, Venezuela</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style3">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_3_4.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">The great wall of china</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style3">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_3_5.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">The Azores, Portugal</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                ...
                <div class="swiper th-slider has-shadow slider-drag-wrap" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_7_1.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">vineyard tour Harvesting</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_7_2.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Cultural Heritage Tour</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_7_3.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Nature & Adventure Tour</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style4 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_7_4.jpg" alt="image">
                                </div>
                                <div class="tour-content">
...
Contact Area  
==============================-->
    <div class="cantact-area6 position-relative  overflow-hidden" data-bg-src="assets/img/bg/contact_bg_6.jpg">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="text-center text-lg-start">
                        <div class="title-area pe-xl-5">
                            ...
                            <h2 class="sec-title text-white">Is there anything I can do for you today?</h2>
                            <p class="contact-text2 text-white">We’love to hear from you. Our friendly team is always here
                                to chat</p>
                        </div>
                        <a href="contact.php" class="th-btn style7 th-icon">Contact Us</a>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container th-container">
            ...
            <div class="slider-area">
                <div class="swiper th-slider destination-slider2 slider-drag-wrap" id="destiSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"}},"effect":"coverflow","coverflowEffect":{"rotate":"-17","stretch":"-8","depth":"330","modifier":"1","slideShadows":"false"},"centeredSlides":"true"}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-box2 gsap-cursor">
                                <div class="destination-img">
                                    <img src="assets/img/destination/destination_6_1.jpg" alt="destination image">
                                    <a href="assets/img/destination/destination_6_1.jpg" class="popup-image">
                        ...
                        <div class="swiper-slide">
                            <div class="destination-box2 gsap-cursor">
                                <div class="destination-img">
                                    <img src="assets/img/destination/destination_6_2.jpg" alt="destination image">
                                    <a href="assets/img/destination/destination_6_2.jpg" class="popup-image">
                                        <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-box2 gsap-cursor">
                                <div class="destination-img">
                                    <img src="assets/img/destination/destination_6_3.jpg" alt="destination image">
                                    <a href="assets/img/destination/destination_6_3.jpg" class="popup-image">
                                        <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-box2 gsap-cursor">
                                <div class="destination-img">
                                    <img src="assets/img/destination/destination_6_4.jpg" alt="destination image">
                                    <a href="assets/img/destination/destination_6_4.jpg" class="popup-image">
                                        <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-box2 gsap-cursor">
                                <div class="destination-img">
                                    <img src="assets/img/destination/destination_6_5.jpg" alt="destination image">
                                    <a href="assets/img/destination/destination_6_5.jpg" class="popup-image">
                                        <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="icon-box mt-60 text-center">
                    <button data-slider-prev="#destiSlider1" class="slider-arrow style5 default"><img src="assets/img/icon/right-arrow2.svg" alt=""></button>
                    <button data-slider-next="#destiSlider1" class="slider-arrow style5 default"><img src="assets/img/icon/left-arrow2.svg" alt=""></button>
                </div>
            </div>
        </div>
...
==============================-->
            ...
            <div class="row gx-24 gy-30">
                <div class="col-xl-4">
                    <div class="blog-grid3 th-ani">
                        ...
                        <div class="blog-grid_content">
                            ...
                            <h3 class="box-title"><a href="blog-details.php">Tourm Commits to Carbon-Neutral Countryside Holidays</a></h3>
                ...
                <div class="col-xl-8">
                    <div class="blog-grid3 style2 th-ani">
                        ...
                        <div class="blog-grid_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">Sep 07, 2024</a>
                                <a href="blog.php">7 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">A Voyage to the World's Cultural and Natural Marvels</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
                    <div class="blog-grid3 th-ani style2 mt-24">
                        ...
                        <div class="blog-grid_content">
                            ...
                            <h3 class="box-title"><a href="blog-details.php">Touring the World's Heritage Wonders</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
                </div>
	...
	Footer Area
==============================-->
    <footer class="footer-wrapper bg-title footer-layout2 footer-layout6" data-bg-src="assets/img/bg/footer_bg_1.jpg">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="widget mb-0 footer-widget">
                            <h4 class="widget_title ">Latest Newsletter</h4>
                            <div class="newsletter-widget">
                                <div class="footer-search-contact mt-30">
                                    ...
                                    <div class="footer-btn mt-10">
                                        <button type="submit" class="th-btn btn-fw style1">Subscribe Now <img src="assets/img/icon/plane2.svg" alt=""></button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="shape-mockup movingX d-none d-xxl-block" data-top="10%" data-left="5%">
            <img src="assets/img/shape/shape_2_10.png" alt="shape">
        </div>
        <div class="shape-mockup movingX d-none d-xxl-block" data-top="20%" data-right="5%">
            <img src="assets/img/shape/shape_2_2.png" alt="shape">
        </div>
    </footer>
