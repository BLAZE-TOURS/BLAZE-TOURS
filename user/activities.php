...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Activities</title>
                    ...
                    <div class="row gy-24 gx-24">
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Paragliding</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                ...
                                                Rating)</span></div>
                                        <a href="activities-details.php" class="woocommerce-review-link">(<span class="count">4.8</span>
                                            Rating)</a>
                                    </div>
                                    <h4 class="tour-box_price"><span class="currency">$980.00</span>/Person</h4>
                                    <div class="tour-action">
                                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                                        <a href="activities-details.php" class="th-btn style4">Detail View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Coastal Adventure </a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Departure</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Cultural Immersion</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Mountain Campaign</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Lake Fishing </a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">Cycling</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="tour-box th-ani">
                                ...
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="activities-details.php">hammock on the beach</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="th-pagination mt-60 mb-0 text-center">
                            <ul>
                                <li><a class="active" href="activities.php">1</a></li>
                                <li><a href="activities.php">2</a></li>
                                <li><a href="activities.php">3</a></li>
                                <li><a href="activities.php">4</a></li>
                                <li><a class="next-page" href="activities.php">Next <img src="assets/img/icon/arrow-right4.svg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Food and drink</a>
                                    <span>(10)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Entertainment</a>
                                    <span>(6)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Sports</a>
                                    <span>(2)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Nature and outdoors</a>
                                    <span>(7)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Culture and events</a>
                                    <span>(9)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Mountain Campaigning</a>
                                    <span>(10)</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Up to 2 hour</a>
                                    <span>(20)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>1 to 4 hour</a>
                                    <span>(24)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>4 hour to 1 day</a>
                                    <span>(25)</span>
                                </li>
                            </ul>
                        </div>
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Gozayan Tour, BD</a>
                                    <span>(26)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>Tourope UK</a>
                                    <span>(27)</span>
                                </li>
                                <li>
                                    <a href="blog.php"><i class="fa-light fa-square-check"></i>European Tours Limited</a>
                                    <span>(29)</span>
                                </li>
                            </ul>
                        </div>
