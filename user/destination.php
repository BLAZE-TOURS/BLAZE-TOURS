...
<head>
    ...
    <title>BLAZE TOURS - destination</title>
                ...
                <div class="col-xxl-9 col-lg-8">
                            ...
                            <div class="row gy-30">
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Dubai</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        ...
                                                        Rating)</span></div>
                                                <a href="destination-details.php" class="woocommerce-review-link">(<span class="count">4.8</span>
                                                    Rating)</a>
                                            </div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Italy</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">France</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Maldives</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Belgium</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Spain</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Greece</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="col-xxl-4 col-xl-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="destination-details.php">Newziland</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                    ...
                    <div class="th-pagination text-center mt-60 mb-0">
                        <ul>
                            ...
                            <li><a class="next-page" href="destination.php">Next <img src="assets/img/icon/arrow-right4.svg" alt=""></a></li>
                        </ul>
                    </div>
                </div>
