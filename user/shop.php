        ...
        <div class="container">
                        ...
                        <div class="row gy-40">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">beach casual-shoe</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Beach football</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Hamok</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Beach Hat</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Sony Black Headphone</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Hoodie With Zipper</a></h3>
                                        <span class="price">$35.00</span>
                                        <div class="woocommerce-product-rating">
                                            <span class="count">(5.00 Review)</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">Trendy Sunglass</a></h3>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.php">V-Neck T-Shirt</a></h3>
                                        <span class="price">$35.00</span>
                                        <div class="woocommerce-product-rating">
                                            <span class="count">(5.00 Review)</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
            ...
            <div class="th-pagination text-center pt-50">
                <ul>
                    ...
                    <li><a class="next-page" href="blog.php">Next <img src="assets/img/icon/arrow-right4.svg" alt=""></a></li>
                </ul>
            </div>
        </div>
    </section><!--==============================
