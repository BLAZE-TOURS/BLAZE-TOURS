...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Home Hiking Style2</title>
                        ...
                        <div class="container">
                            <div class="hero-style10">
                                ...
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                    <a href="destination.php" class="th-btn style2 th-icon">Explore Tours</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="category-card style5 single2">
                                ...
                                <h3 class="box-title"><a href="destination.php">Cruises</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style5 single2">
                                ...
                                <h3 class="box-title"><a href="destination.php">Hiking</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style5 single2">
                                ...
                                <h3 class="box-title"><a href="destination.php">Airbirds</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style5 single2">
                                ...
                                <h3 class="box-title"><a href="destination.php">Wildlife</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style5 single2">
                                ...
                                <h3 class="box-title"><a href="destination.php">Walking</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                ...
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.php"><img src="assets/img/icon/location-dot4.svg" alt="">Thailand</a></h3>
                                </div>
                                <a href="contact.php" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                ...
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.php"><img src="assets/img/icon/location-dot4.svg" alt="">Belgium</a></h3>
                                </div>
                                <a href="contact.php" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                ...
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.php"><img src="assets/img/icon/location-dot4.svg" alt="">Island</a></h3>
                                </div>
                                <a href="contact.php" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item4 th-ani">
                                ...
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="destination-details.php"><img src="assets/img/icon/location-dot4.svg" alt="">Maldives</a></h3>
                                </div>
                                <a href="contact.php" class="icon-btn"><img src="assets/img/icon/left-arrow4.svg" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-grid2">
                                ...
                                <div class="team-content">
                                    <h3 class="box-title"><a href="tour-guider-details.php">Mishel Marsh</a></h3>
                                    <div class="th-social">
                                        <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                        <a href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                        <a href="https://www.twitter.com/"><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">The Plaza, New York</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Hotel Ritz Paris</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Claridge’s, London</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Taj Mahal Palace, India</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Peninsula Hong Kong</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">The Ritz Hotel London</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">The Shelbourne Hotel, Dublin</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Beverly Hills Hotel</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Caravan Trip Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Sleeper Buses Package </a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Trips by Train Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Travel by Air Flight Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="tour-details.php">Cruise Transports Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">10 Reason why you should visit New Jersy</a></h3>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">The best time to visit japan & enjoy the cherry blossoms</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">The 7 amazing destinations for adventure seekers</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
