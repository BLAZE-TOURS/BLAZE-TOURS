...
<head>
    ...
    <title>Tourm - Travel & Tour Booking Agency HTML Template - Home Beach</title>
...
Hero Area
==============================-->
    <div class="th-hero-wrapper hero-5" id="hero" data-bg-src="assets/img/bg/hero_bg_5_1.png">
            ...
            <div class="swiper-wrapper">
                        ...
                        <div class="container">
                            <div class="hero-style5">
                                ...
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                    <a href="tour.php" class="th-btn style2 th-icon">Explore Tours</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        ...
                        <div class="th-hero-image">
                            <div class="hero-img" data-ani="slideinleft" data-ani-delay="0.8s">
                                <img src=" assets/img/hero/hero_5_1_2.jpg" alt="">
                            </div>
                            <div class="hero-img2" data-ani="slideinright" data-ani-delay="0.9s">
                                <img src=" assets/img/hero/hero_5_2_2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="hero-inner">
                        ...
                        <div class="th-hero-image">
                            <div class="hero-img" data-ani="slideinleft" data-ani-delay="0.8s">
                                <img src=" assets/img/hero/hero_5_1_3.jpg" alt="">
                            </div>
                            <div class="hero-img2" data-ani="slideinright" data-ani-delay="0.9s">
                                <img src=" assets/img/hero/hero_5_2_3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-wrap">
                    <div class="row align-items-center justify-content-between">
                        <div class="form-group col-md-6 col-lg-auto">
                            <div class="booking-client-box mb-sm-0 mb-3">
                                <div class="client-thumb-group">
                                    <div class="thumb"><img src="assets/img/shape/client-img-1-1.png" alt="avater"></div>
                                    <div class="thumb"><img src="assets/img/shape/client-img-1-2.png" alt="avater"></div>
                                    <div class="thumb"><img src="assets/img/shape/client-img-1-3.png" alt="avater"></div>
                        ...
                        <div class="form-btn col-md-12 col-lg-auto">
                            <button class="th-btn style3"><img src="assets/img/icon/search.svg" alt="">Search</button>
                        </div>
                    </div>
                ...
                <div class="swiper th-slider has-shadow categorySlider4" id="categorySlider4" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"5"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="category-card style2">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_2_1.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Maldives Beach</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style2">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_2_2.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Boulders Beach</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style2">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_2_3.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Bondi Beach</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style2">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_2_4.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Copacabana Beach</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card style2">
                                <div class="box-img global-img">
                                    <img src="assets/img/category/category_2_5.jpg" alt="Image">
                                </div>
                                <h3 class="box-title"><a href="destination.php">Maldives Beach</a></h3>
                                <a class="line-btn" href="destination.php">See more</a>
                            </div>
...
==============================-->
    <div class="bg-smoke position-relative overflow-hidden space" id="about-sec" data-bg-src="assets/img/bg/shape_bg_1.png">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="img-box4 space-bottom">
                        <div class="img1">
                ...
                <div class="col-xl-6">
                    <div class="ps-xl-5">
                        <div class="title-area">
                            ...
                            <h2 class="sec-title">Begin Your Travel Story with Us</h2>
        ...
        <div class="shape-mockup d-none d-xxl-block" data-bottom="0%" data-right="0%"><img src="assets/img/normal/about-slide-img2.png" alt="">
        </div>
    </div><!--==============================
Brand Area  
==============================-->
                ...
                <div class="swiper th-slider has-shadow slider-drag-wrap" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tour-box style3 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_6_1.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Bali Private Beach Package</a></h3>
                                    ...
                                    <div class="tour-action">
                                        ...
                                        <a href="tour-guider-details.php" class="th-btn style4 th-icon">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style3 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_6_2.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Maldives Beach Package</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style3 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_6_3.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Island Beach Package</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style3 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour_6_4.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Boulders Beach Package</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                    ...
                    <div class="col-lg-7">
                        <div class="space">
                            <div class="title-area mb-40">
                                <span class="sub-title style1 text-white">This Summer Offer</span>
                                <h2 class="sec-title cta-title text-white">Get 30% Off</h2>
                                <h2 class="sec-title text-white">Next trip, From Our Mobile App</h2>
                                <p class="text-white">Travel from Aug 25 to Nov 28 for exciting offers and guaranteed
                                    rewards.
                                </p>
                            </div>
                            <div class="btn-group">
                                <a href="about.php" class="th-btn style2 th-icon">Learn More</a>
                                <a href="contact.php" class="th-btn style6 th-icon">Download App</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
...
==============================-->
    <div class="counter-sec2 space">
        ...
        <div class="shape-mockup shape3 d-none d-xl-block" data-top="36%" data-left="7%">
            <img src="assets/img/shape/shape_3.png" alt="shape">
        </div>
        <div class="shape-mockup movingX d-none d-xl-block" data-bottom="0%" data-right="5%">
            <img src="assets/img/shape/shape_16.png" alt="shape">
        </div>
    </div> <!--==============================
Testimonial Area  
==============================-->
    <section class="testi-area5 bg-smoke overflow-hidden space" id="testi-sec" data-bg-src="assets/img/bg/shape_bg_1.png">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="testi-image-wrapp">
                        <div class="testi-img">
                            <img src="assets/img/testimonial/testi-img-1.jpg" alt="">
                        </div>
                        <div class="testi-img style2">
                            <img src="assets/img/testimonial/testi-img-2.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    ...
                    <div class="swiper th-slider testi-grid2-thumb" id="testiSlide6" data-slider-options='{"effect":"slide","slidesPerView":"6","spaceBetween":7,"loop":false}'>
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_4_1.png" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_4_2.png" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_4_3.png" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="box-img">
                                    <img src="assets/img/testimonial/testi_4_4.png" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
        ...
        <div class="shape-mockup d-none d-xl-block" data-bottom="0%" data-left="0%">
            <img class="gmovingX" src="assets/img/shape/shape_17.png" alt="shape">
        </div>
        <div class="shape-mockup d-none d-xl-block" data-bottom="25%" data-right="0%">
            <img src="assets/img/shape/shape_18.png" alt="shape">
        </div>
    </section><!--==============================
Contact Area  
==============================-->
                ...
                <div class="col-lg-6">
                    <div class="pt-75 ps-xl-5 ms-xl-5">
                        <div class="title-area mb-10">
                            ...
                            <p class="text-white mb-0">We’love to hear from you. Our friendly team is always here to chat</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row gx-24 gy-30">
                <div class="col-xl-8">
                    <div class="blog-grid2 style2 th-ani">
                        ...
                        <div class="blog-grid2_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">Sep 09, 2024</a>
                                <a href="blog.php">6 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">Tourm Reveals New Eco-Friendly Resort in
                                    Maldives</a></h3>
                    ...
                    <div class="blog-grid2 th-ani style2 mt-24">
                        ...
                        <div class="blog-grid2_content">
                            ...
                            <h3 class="box-title"><a href="blog-details.php">Essential Packing List for Your Next Beach
                                    Vacation</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
                ...
                <div class="col-xl-4">
                    <div class="blog-grid2 th-ani">
                        ...
                        <div class="blog-grid2_content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php">Sep 05, 2024</a>
                                <a href="blog.php">6 min read</a>
                            </div>
                            <h3 class="box-title"><a href="blog-details.php">Tourm Commits to Carbon-Neutral Beach
                                    Holidays</a></h3>
                            <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                        </div>
                    </div>
...
gallery-thumb Area  
==============================-->
    <div class="sidebar-gallery-area bg-smoke space" data-bg-src="assets/img/bg/shape_bg_1.png">
        <div class="container-fluid">
            <div class="title-area text-center">
                <span class="sub-title">We Are On Instagram</span>
