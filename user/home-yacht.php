                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="home-travel.php"><img src="assets/img/logo4.svg" alt="Tourm"></a>
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                <a href="contact.php" class="th-btn style1 th-icon">Book Now</a>
...
Hero Area
==============================-->
    <div class="th-hero-wrapper bg-bottom-center hero-4" id="hero" data-bg-src="assets/img/bg/hero_bg_4_1.png">
        <div class="container">
            <div class="hero-style4 text-center">
                ...
                <div class="btn-group">
                    ...
                    <a href="service.php" class="th-btn style3 th-icon">Our Services</a>
                </div>
            </div>
        </div>
                ...
                <div class="swiper th-slider has-shadow slider-drag-wrap" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3","spaceBetween":"24"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tour-box style2 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour-1_1.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Aquavita Boat</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style2 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour-1_2.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Golden Odyssey</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="tour-box style2 th-ani gsap-cursor">
                                <div class="tour-box_img global-img">
                                    <img src="assets/img/tour/tour-1_3.jpg" alt="image">
                                </div>
                                <div class="tour-content">
                                    <h3 class="box-title"><a href="tour-details.php">Luxury Motor Yacht</a></h3>
                                    <div class="tour-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                Rating)</span></div>
...
Team Area  
==============================-->
    <section class="bg-smoke position-relative space" data-bg-src="assets/img/bg/shape_bg_1.png">
        <div class="container z-index-common">
            ...
            <div class="slider-area teamSlider4">
                ...
                <button data-slider-prev="#teamSlider4" class="slider-arrow slider-prev"><img src="assets/img/icon/right-arrow2.svg" alt=""></button>
                <button data-slider-next="#teamSlider4" class="slider-arrow slider-next"><img src="assets/img/icon/left-arrow2.svg" alt=""></button>
            </div>
        </div>
    </section><!--==============================
Contact Area  
==============================-->
    <div class="bg-top-center space-top overflow-hidden" data-bg-src="assets/img/bg/contact_bg_2.jpg">
        <div class="container">
            <div class="row">
...
==============================-->
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">Discovering Paradise in The Maldives</a></h3>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">Experiencing Paradise in The Indonesia Bali</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="blog-box style2 th-ani">
                                ...
                                <div class="blog-box_content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.php">Journey to Paradise in The Wang Beach in London</a></h3>
                                    <a href="blog-details.php" class="th-btn style4 th-icon">Read More</a>
                                </div>
                            </div>
                        </div>
	...
	Footer Area
==============================-->
    <footer class="footer-wrapper bg-theme footer-layout4">
                ...
                <div class="newsletter-area">
                    <div class="newsletter-top">
                        <div class="row gy-4 align-items-center">
                            <div class="col-lg-5">
                                <h2 class="newsletter-title text-capitalize mb-0 text-white">get updated the latest newsletter</h2>
                            </div>
                            <div class="col-lg-7">
                                <form class="newsletter-form style4">
                                    <input class="form-control " type="email" placeholder="Enter Email" required="">
                                    <button type="submit" class="th-btn style5">Subscribe Now <img src="assets/img/icon/plane.svg" alt=""></button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="home-travel.php"><img src="assets/img/logo5.svg" alt="Tourm"></a>
                                </div>
                                <p class="about-text">Rapidiously myocardinate cross-platform intellectual capital model. Appropriately create interactive infrastructures</p>
                                <div class="th-social">
                                    <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                        ...
                        <div class="widget footer-widget">
                            <div class="sidebar-gallery">
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_1.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_1.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_2.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_2.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_3.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_3.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_4.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_4.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_5.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_5.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="gallery-thumb">
                                    <img src="assets/img/widget/gallery_2_6.jpg" alt="Gallery Image">
                                    <a href="assets/img/widget/gallery_2_6.jpg" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="shape-mockup jump d-none d-xxl-block" data-top="15%" data-left="0%">
            <img src="assets/img/shape/footer4-shape.png" alt="shape">
        </div>
        <div class="shape-mockup d-none d-xxl-block" data-top="30%" data-right="0%">
